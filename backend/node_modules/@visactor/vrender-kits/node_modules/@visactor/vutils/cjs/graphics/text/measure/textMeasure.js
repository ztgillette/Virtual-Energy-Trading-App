...
class TextMeasure {
    ...
    initContext() {
        ...
        (0, common_1.isNil)(this._canvas) && "undefined" != typeof window && void 0 !== window.document && globalThis && (0, 
    ...
    _initSpec() {
        ...
        if ((0, common_1.isString)(lineHeight) && "%" === lineHeight[lineHeight.length - 1]) {
    ...
    _quickMeasure(text) {
        ...
        for (let i = 0; i < text.length; i++) {
            ...
            totalSize.height = Math.max(totalSize.height, size.height), !(0, common_1.isNil)(size.fontBoundingBoxAscent) && (totalSize.fontBoundingBoxAscent = size.fontBoundingBoxAscent), 
            !(0, common_1.isNil)(size.fontBoundingBoxDescent) && (totalSize.fontBoundingBoxDescent = size.fontBoundingBoxDescent);
        }
        return totalSize;
    }
