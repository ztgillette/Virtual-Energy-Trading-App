...
let DefaultMathCirclePicker = class extends base_1.PickerBase {
    constructor(canvasRenderer) {
        super(), this.canvasRenderer = canvasRenderer, this.type = "circle", this.numberType = vrender_core_1.CIRCLE_NUMBER_TYPE;
    }
};

DefaultMathCirclePicker = __decorate([ (0, vrender_core_1.injectable)(), __param(0, (0, 
vrender_core_1.inject)(vrender_core_1.CircleRender)), __metadata("design:paramtypes", [ Object ]) ], DefaultMathCirclePicker), 
