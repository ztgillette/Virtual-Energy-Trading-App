...
let DefaultMathSymbolPicker = class extends base_1.PickerBase {
    constructor(canvasRenderer) {
        super(), this.canvasRenderer = canvasRenderer, this.type = "symbol", this.numberType = vrender_core_1.SYMBOL_NUMBER_TYPE;
    }
};

DefaultMathSymbolPicker = __decorate([ (0, vrender_core_1.injectable)(), __param(0, (0, 
vrender_core_1.inject)(vrender_core_1.SymbolRender)), __metadata("design:paramtypes", [ Object ]) ], DefaultMathSymbolPicker), 
