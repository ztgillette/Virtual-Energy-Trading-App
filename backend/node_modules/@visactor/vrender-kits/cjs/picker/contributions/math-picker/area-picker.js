...
let DefaultMathAreaPicker = class extends base_1.PickerBase {
    constructor(canvasRenderer) {
        super(), this.canvasRenderer = canvasRenderer, this.type = "area", this.numberType = vrender_core_1.AREA_NUMBER_TYPE;
    }
};

DefaultMathAreaPicker = __decorate([ (0, vrender_core_1.injectable)(), __param(0, (0, 
vrender_core_1.inject)(vrender_core_1.AreaRender)), __metadata("design:paramtypes", [ Object ]) ], DefaultMathAreaPicker), 
