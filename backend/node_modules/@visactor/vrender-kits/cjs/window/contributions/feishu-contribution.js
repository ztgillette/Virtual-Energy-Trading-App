...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.feishuWindowModule = exports.FeishuWindowHandlerContribution = void 0;

const vrender_core_1 = require("@visactor/vrender-core"), feishu_1 = require("../../canvas/contributions/feishu");
...
let FeishuWindowHandlerContribution = class extends vrender_core_1.BaseWindowHandlerContribution {
    get container() {
        return null;
    }
    constructor(global) {
...
vrender_core_1.injectable)(), __param(0, (0, vrender_core_1.inject)(vrender_core_1.VGlobal)), __metadata("design:paramtypes", [ Object ]) ], FeishuWindowHandlerContribution), 
exports.FeishuWindowHandlerContribution = FeishuWindowHandlerContribution, exports.feishuWindowModule = new vrender_core_1.ContainerModule((bind => {
    bind(FeishuWindowHandlerContribution).toSelf(), bind(vrender_core_1.WindowHandlerContribution).toDynamicValue((ctx => ctx.container.get(FeishuWindowHandlerContribution))).whenTargetNamed(FeishuWindowHandlerContribution.env);
}));
