...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.harmonyWindowModule = exports.HarmonyWindowHandlerContribution = void 0;

const vrender_core_1 = require("@visactor/vrender-core"), harmony_1 = require("../../canvas/contributions/harmony");
...
let HarmonyWindowHandlerContribution = class extends vrender_core_1.BaseWindowHandlerContribution {
    get container() {
        return null;
    }
    constructor(global) {
    ...
    createWindowByConfig(params) {
        ...
        this.canvas = new harmony_1.HarmonyCanvas(options);
    }
    createWindowByCanvas(params) {
        ...
        this.canvas = new harmony_1.HarmonyCanvas({
            width: width,
            height: height,
            dpr: 1,
            nativeCanvas: canvas,
...
HarmonyWindowHandlerContribution.env = "harmony", HarmonyWindowHandlerContribution = __decorate([ (0, 
vrender_core_1.injectable)(), __param(0, (0, vrender_core_1.inject)(vrender_core_1.VGlobal)), __metadata("design:paramtypes", [ Object ]) ], HarmonyWindowHandlerContribution), 
exports.HarmonyWindowHandlerContribution = HarmonyWindowHandlerContribution, exports.harmonyWindowModule = new vrender_core_1.ContainerModule((bind => {
    bind(HarmonyWindowHandlerContribution).toSelf(), bind(vrender_core_1.WindowHandlerContribution).toDynamicValue((ctx => ctx.container.get(HarmonyWindowHandlerContribution))).whenTargetNamed(HarmonyWindowHandlerContribution.env);
}));
