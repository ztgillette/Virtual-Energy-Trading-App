...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.lynxWindowModule = exports.LynxWindowHandlerContribution = void 0;
...
let LynxWindowHandlerContribution = class extends vrender_core_1.BaseWindowHandlerContribution {
    get container() {
        return null;
    }
    constructor(global) {
...
vrender_core_1.injectable)(), __param(0, (0, vrender_core_1.inject)(vrender_core_1.VGlobal)), __metadata("design:paramtypes", [ Object ]) ], LynxWindowHandlerContribution), 
exports.LynxWindowHandlerContribution = LynxWindowHandlerContribution, exports.lynxWindowModule = new vrender_core_1.ContainerModule((bind => {
    bind(LynxWindowHandlerContribution).toSelf(), bind(vrender_core_1.WindowHandlerContribution).toDynamicValue((ctx => ctx.container.get(LynxWindowHandlerContribution))).whenTargetNamed(LynxWindowHandlerContribution.env);
}));
