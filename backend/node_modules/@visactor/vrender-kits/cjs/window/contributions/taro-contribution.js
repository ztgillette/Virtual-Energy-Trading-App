...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.taroWindowModule = exports.TaroWindowHandlerContribution = void 0;

const vrender_core_1 = require("@visactor/vrender-core"), taro_1 = require("../../canvas/contributions/taro");
...
let TaroWindowHandlerContribution = class extends vrender_core_1.BaseWindowHandlerContribution {
    get container() {
        return null;
    }
    constructor(global) {
...
vrender_core_1.injectable)(), __param(0, (0, vrender_core_1.inject)(vrender_core_1.VGlobal)), __metadata("design:paramtypes", [ Object ]) ], TaroWindowHandlerContribution), 
exports.TaroWindowHandlerContribution = TaroWindowHandlerContribution, exports.taroWindowModule = new vrender_core_1.ContainerModule((bind => {
    bind(TaroWindowHandlerContribution).toSelf(), bind(vrender_core_1.WindowHandlerContribution).toDynamicValue((ctx => ctx.container.get(TaroWindowHandlerContribution))).whenTargetNamed(TaroWindowHandlerContribution.env);
}));
