...
DefaultMathAreaPicker = __decorate([ injectable(), __param(0, inject(AreaRender)), __metadata("design:paramtypes", [ Object ]) ], DefaultMathAreaPicker);

export { DefaultMathAreaPicker };
