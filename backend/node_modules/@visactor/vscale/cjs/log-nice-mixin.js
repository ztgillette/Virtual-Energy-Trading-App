...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.LogNiceMixin = void 0;

const tick_sample_1 = require("./utils/tick-sample"), utils_1 = require("./utils/utils");
...
class LogNiceMixin {
    nice(count = 10, option) {
        ...
        if (niceType) {
            const niceDomain = (0, utils_1.nice)(originalDomain.slice(), null !== (_c = null === (_b = this.getNiceConfig) || void 0 === _b ? void 0 : _b.call(this)) && void 0 !== _c ? _c : {
...
exports.LogNiceMixin = LogNiceMixin;
