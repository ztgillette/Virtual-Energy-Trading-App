...
class OrdinalScale extends base_scale_1.BaseScale {
    ...
    constructor() {
        super(), this.type = type_1.ScaleEnum.Ordinal, this._index = new Map, this._domain = [], 
        this._ordinalRange = [], this._unknown = exports.implicit;
    }
    clone() {
    ...
    scale(d) {
        ...
        if (!i) {
            if (this._unknown !== exports.implicit) return this._unknown;
