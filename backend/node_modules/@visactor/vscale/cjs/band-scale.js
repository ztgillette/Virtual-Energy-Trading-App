...
class BandScale extends ordinal_scale_1.OrdinalScale {
    ...
    rescale(slience, changeProperty) {
        ...
        this._bandRangeState = {
            reverse: reverse,
            start: reverse ? (0, vutils_1.clamp)(start + this._step * (n - 1), wholeRange[1], wholeRange[0]) : (0, 
            vutils_1.clamp)(start, wholeRange[0], wholeRange[1]),
    ...
    scale(d) {
        ...
        return (0, vutils_1.clamp)(this._fishEyeTransform ? this._fishEyeTransform(output) : output, min, max);
    }
