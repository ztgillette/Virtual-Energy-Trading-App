...
const vrender_kits_1 = require("@visactor/vrender-kits"), axis_animate_1 = require("../animation/axis-animate");

function loadBasicAxis() {
    (0, vrender_kits_1.registerGroup)(), (0, vrender_kits_1.registerLine)(), (0, vrender_kits_1.registerRichtext)(), 
    (0, vrender_kits_1.registerText)(), (0, axis_animate_1.registerAxisAnimate)();
}
