...
class Tag extends base_1.AbstractComponent {
    ...
    render() {
        ...
        if ((0, util_1.isRichText)({
            ...
            const richTextAttrs = Object.assign(Object.assign(Object.assign({}, (0, util_1.richTextAttributeTransform)(Object.assign({
                type: type,
                text: text
            }, textStyle))), textStyle), {
        ...
        if (visible && (0, vutils_1.isBoolean)(bgVisible)) {
            ...
            backgroundStyle.customShape) {
                ...
                bgRect.pathProxy = attrs => customShape(this, attrs, new vrender_core_1.CustomPath2D);
            }
            this._bgRect = bgRect;
        }
