...
const isNumber_1 = __importDefault(require("./common/isNumber")), hasConsole = "undefined" != typeof console;
...
class Logger {
    static getInstance(level, method) {
        return Logger._instance && (0, isNumber_1.default)(level) ? Logger._instance.level(level) : Logger._instance || (Logger._instance = new Logger(level, method)), 
        Logger._instance;
    }
