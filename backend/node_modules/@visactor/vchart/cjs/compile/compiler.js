...
const event_1 = require("./../constant/event"), interface_1 = require("./interface"), env_1 = require("../util/env"), type_1 = require("../util/type"), vutils_1 = require("@visactor/vutils"), vrender_core_1 = require("@visactor/vrender-core"), factory_1 = require("../core/factory"), mark_1 = require("../util/mark"), util_1 = require("./util"), debug_1 = require("../util/debug");
...
class Compiler {
    ...
    renderMarks() {
        ...
        (0, debug_1.log)(`--- start of renderMarks(${this._count}) ---`), this._count++);
    }
