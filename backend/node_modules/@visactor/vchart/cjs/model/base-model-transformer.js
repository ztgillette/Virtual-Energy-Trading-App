...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.BaseModelSpecTransformer = void 0;

const util_1 = require("../util"), vutils_extension_1 = require("@visactor/vutils-extension");
...
class BaseModelSpecTransformer {
    ...
    _mergeThemeToSpec(spec, chartSpec) {
        ...
        if (this._shouldMergeThemeToSpec()) {
            const specFromChart = this._getDefaultSpecFromChart(chartSpec), merge = originalSpec => (0, 
            vutils_extension_1.mergeSpec)({}, theme, specFromChart, originalSpec);
...
exports.BaseModelSpecTransformer = BaseModelSpecTransformer;
