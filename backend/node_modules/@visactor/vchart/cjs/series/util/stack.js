...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.stackWithMinHeight = void 0;

const scale_1 = require("../../util/scale");
...
function computeOneDatumY(obj, lastY, s, context, seriesScale, isFirst) {
    const barMinHeight = s.getSpec().barMinHeight, inverse = s[context.axisHelper].isInverse(), y1 = (0, 
    scale_1.valueInScaleRange)(s[context.startMethod](obj), seriesScale);
    let y = (0, scale_1.valueInScaleRange)(s[context.endMethod](obj), seriesScale);
    isFirst && (lastY = y1);
...
exports.stackWithMinHeight = stackWithMinHeight;
