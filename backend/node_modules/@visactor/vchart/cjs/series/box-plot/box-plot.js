...
class BoxPlotSeries extends cartesian_1.CartesianSeries {
    ...
    initMarkStyle() {
        ...
        if (boxPlotMark) {
            ...
            this.setMarkStyle(boxPlotMark, boxPlotMarkStyles, interface_1.STATE_VALUE_ENUM.STATE_NORMAL, attribute_1.AttributeLevel.Series);
        }
