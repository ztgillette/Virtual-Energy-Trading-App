...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.registerDataSamplingTransform = exports.dataSampling = void 0;

const vutils_1 = require("@visactor/vutils"), math_1 = require("../../util/math"), factory_1 = require("../../core/factory"), samplerMap = {
    min: vutils_1.minInArray,
    max: vutils_1.maxInArray,
    average: math_1.average,
    sum: math_1.sum
};
...
const dataSampling = (options, upstreamData) => {
    let size = (0, vutils_1.isFunction)(options.size) ? options.size() : options.size;
...
exports.dataSampling = dataSampling;

const registerDataSamplingTransform = () => {
    factory_1.Factory.registerGrammarTransform("dataSampling", {
        transform: exports.dataSampling
    });
};

exports.registerDataSamplingTransform = registerDataSamplingTransform;
