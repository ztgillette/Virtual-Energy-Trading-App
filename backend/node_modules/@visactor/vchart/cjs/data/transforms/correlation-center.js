...
const vutils_1 = require("@visactor/vutils"), data_1 = require("../../constant/data"), correlationCenter = (data, options) => {
    ...
    return {
        ...
        [data_1.DEFAULT_DATA_SERIES_FIELD]: null == nodeInfo ? void 0 : nodeInfo[data_1.DEFAULT_DATA_SERIES_FIELD]
    };
};

exports.correlationCenter = correlationCenter;
