...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.getCartesianCrosshairRect = exports.layoutCrosshair = exports.layoutByValue = void 0;
...
const vscale_1 = require("@visactor/vscale"), common_1 = require("./common"), util_1 = require("../../axis/util"), vutils_1 = require("@visactor/vutils"), util_2 = require("../../util"), layoutByValue = (stateByField, series, layoutStartPoint, enableRemain = !1) => (layoutStartPoint || (layoutStartPoint = {
    ...
    if (attributes && currentValue.forEach((({axis: axis, datum: value = ""}) => {
        ...
        if (newCacheInfo && (null === (_a = attributes.label) || void 0 === _a ? void 0 : _a.visible) && !useCache) {
            const labelOffset = (0, util_1.getAxisLabelOffset)(axis.getSpec()), axisOrient = axis.getOrient(), syncAxisLabelAngle = null === (_b = attributes.label) || void 0 === _b ? void 0 : _b.syncAxisLabelAngle;
...
const getRectSize = (hair, bandSize, offsetSize, axis) => {
...
}, getCartesianCrosshairRect = (dimensionData, layoutStartPoint) => {
    var _a;
    ...
    return (0, exports.layoutByValue)(state, series, layoutStartPoint), state.xField.cacheInfo ? (0, 
    exports.layoutCrosshair)(state.xField) : state.yField.cacheInfo ? (0, exports.layoutCrosshair)(state.yField) : void 0;
};
