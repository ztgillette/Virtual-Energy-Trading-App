...
const layout_1 = require("./../../constant/layout"), projection_1 = require("./projection"), type_1 = require("../interface/type"), base_component_1 = require("../base/base-component"), model_1 = require("../../util/model"), vutils_extension_1 = require("@visactor/vutils-extension"), event_1 = require("../../constant/event"), base_1 = require("../../constant/base"), type_2 = require("../../series/interface/type"), zoomable_1 = require("../../interaction/zoom/zoomable"), vutils_1 = require("@visactor/vutils"), map_1 = require("../../data/transforms/map"), factory_1 = require("../../core/factory");

function projectionName(key, id) {
    return `${base_1.PREFIX}_${id}_${key}`;
}
...
class GeoCoordinate extends base_component_1.BaseComponent {
    constructor() {
        ...
        this.layoutType = "none", this.layoutZIndex = layout_1.LayoutZIndex.Mark, this._projectionSpec = {
    ...
    setAttrFromSpec() {
        ...
        this._projectionSpec = (0, vutils_extension_1.mergeSpec)(this._projectionSpec, this._spec.projection), 
    ...
    coordinateHelper() {
        ...
        this._regions.forEach((r => {
            r.getSeries().forEach((s => {
                s.type === type_2.SeriesTypeEnum.map || s.type === type_2.SeriesTypeEnum.pictogram ? s.setCoordinateHelper(helper) : (s.setXAxisHelper(Object.assign(Object.assign({}, helper), {
                    isContinuous: !0,
    ...
    onLayoutEnd() {
        ...
        center && this._projection.center(center), (0, model_1.eachSeries)(this._regions, (s => {
            var _a;
            if (s.type === type_2.SeriesTypeEnum.map || s.type === type_2.SeriesTypeEnum.pictogram) {
    ...
    collectFeatures() {
        ...
        return this._regions.forEach((r => {
            r.getSeries().forEach((s => {
                var _a, _b;
                s.type !== type_2.SeriesTypeEnum.map && s.type !== type_2.SeriesTypeEnum.pictogram || features.push(...null !== (_b = null === (_a = s.getMapViewData()) || void 0 === _a ? void 0 : _a.latestData) && void 0 !== _b ? _b : []);
            }));
        })), features;
    }
    ...
    _compareSpec(spec, prevSpec) {
        ...
        return result.reMake || (result.reMake = [ "roam", "longitudeField", "latitudeField", "projection", "zoomLimit" ].some((k => !(0, 
        vutils_1.isEqual)(null == prevSpec ? void 0 : prevSpec[k], spec[k])))), result;
    }
    release() {
