...
class BaseMarkPoint extends base_marker_1.BaseMarker {
    ...
    _createMarkerComponent() {
        ...
        defaultStyle = {
            dx: 0,
            dy: 0
        }, itemContentStyle = (0, utils_1.transformLabelAttributes)((0, vutils_1.merge)(defaultStyle, null !== (_b = null != label ? label : textStyle) && void 0 !== _b ? _b : style), this._markerData, this._markAttributeContext)) : "richText" === type ? (itemContentState = null !== (_c = null == richText ? void 0 : richText.state) && void 0 !== _c ? _c : state, 
        defaultStyle = {
            width: 100,
            height: 100
        }, itemContentStyle = (0, utils_1.transformStyle)((0, vutils_1.merge)(defaultStyle, null !== (_e = null !== (_d = null == richText ? void 0 : richText.style) && void 0 !== _d ? _d : richTextStyle) && void 0 !== _e ? _e : style), this._markerData, this._markAttributeContext)) : "symbol" === type ? (itemContentState = null !== (_f = null == symbol ? void 0 : symbol.state) && void 0 !== _f ? _f : state, 
        defaultStyle = {
            symbolType: "star",
            fill: "rgb(48, 115, 242)",
            fillOpacity: .8,
            size: 20
        }, itemContentStyle = (0, style_1.transformToGraphic)((0, utils_1.transformStyle)((0, 
        vutils_1.merge)(defaultStyle, null !== (_h = null !== (_g = null == symbol ? void 0 : symbol.style) && void 0 !== _g ? _g : symbolStyle) && void 0 !== _h ? _h : style), this._markerData, this._markAttributeContext))) : "image" === type ? (itemContentState = null !== (_j = null == image ? void 0 : image.state) && void 0 !== _j ? _j : state, 
        defaultStyle = {
            width: 80,
            height: 80
        }, itemContentStyle = (0, utils_1.transformStyle)((0, vutils_1.merge)(defaultStyle, null !== (_l = null !== (_k = null == image ? void 0 : image.style) && void 0 !== _k ? _k : imageStyle) && void 0 !== _l ? _l : style), this._markerData, this._markAttributeContext)) : "custom" === type && (itemContentState = null !== (_m = null == customMark ? void 0 : customMark.state) && void 0 !== _m ? _m : state, 
        itemContentStyle = (0, utils_1.transformStyle)(null !== (_p = null !== (_o = null == customMark ? void 0 : customMark.style) && void 0 !== _o ? _o : customMarkStyle) && void 0 !== _p ? _p : style, this._markerData, this._markAttributeContext));
        const markPointAttrs = {
            ...
            itemContent: Object.assign(Object.assign({
                ...
                style: (0, utils_1.transformStyle)(itemContentStyle, this._markerData, this._markAttributeContext)
            }),
            targetSymbol: {
            ...
            state: {
                line: (0, utils_1.transformState)(null !== (_y = null === (_x = this._spec.itemLine.line) || void 0 === _x ? void 0 : _x.state) && void 0 !== _y ? _y : {}, this._markerData, this._markAttributeContext),
                lineStartSymbol: (0, utils_1.transformState)(null !== (_0 = null === (_z = this._spec.itemLine.startSymbol) || void 0 === _z ? void 0 : _z.state) && void 0 !== _0 ? _0 : {}, this._markerData, this._markAttributeContext),
                lineEndSymbol: (0, utils_1.transformState)(null !== (_2 = null === (_1 = this._spec.itemLine.endSymbol) || void 0 === _1 ? void 0 : _1.state) && void 0 !== _2 ? _2 : {}, this._markerData, this._markAttributeContext),
                itemContent: (0, utils_1.transformState)(itemContentState, this._markerData, this._markAttributeContext),
                textBackground: (0, utils_1.transformState)(null === (_4 = null === (_3 = this._spec.itemContent.text) || void 0 === _3 ? void 0 : _3.labelBackground) || void 0 === _4 ? void 0 : _4.state, this._markerData, this._markAttributeContext),
                targetItem: (0, utils_1.transformState)(null !== (_6 = null === (_5 = this._spec.targetSymbol) || void 0 === _5 ? void 0 : _5.state) && void 0 !== _6 ? _6 : {}, this._markerData, this._markAttributeContext)
            },
