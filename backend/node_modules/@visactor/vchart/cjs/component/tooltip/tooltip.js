...
const type_1 = require("../interface/type"), base_component_1 = require("../base/base-component"), env_1 = require("../../util/env"), show_tooltip_1 = require("./utils/show-tooltip"), common_1 = require("./utils/common"), common_2 = require("../../event/events/dimension/util/common"), event_1 = require("../../constant/event"), util_1 = require("./processor/util"), vutils_1 = require("@visactor/vutils"), vchart_1 = require("../../core/vchart"), factory_1 = require("../../core/factory"), tooltip_transformer_1 = require("./tooltip-transformer"), util_2 = require("../../util"), constant_1 = require("./constant"), tooltip_1 = require("../../theme/builtin/common/component/tooltip");
...
class Tooltip extends base_component_1.BaseComponent {
    constructor() {
        ...
        this._eventList = [], this._isTooltipShown = !1, this._clickLock = !1, this._mountEvent = (eType, query, callback) => {
            ...
            }), null !== (_e = null === (_d = this._spec) || void 0 === _d ? void 0 : _d.showDelay) && void 0 !== _e ? _e : constant_1.DEFAULT_SHOW_DELAY) : this._handleChartMouseOut(params));
        }, this._handleChartMouseOut = params => {
            ...
            }), null !== (_d = null === (_c = this._spec) || void 0 === _c ? void 0 : _c.showDelay) && void 0 !== _d ? _d : constant_1.DEFAULT_SHOW_DELAY)) : this._handleChartMouseMove(params, isClick)));
        }, this._handleChartMouseMove = (params, isClick) => {
            if (this._isReleased) return;
            ...
            return success && vchart_1.VChart.globalConfig.uniqueTooltip && vchart && vchart_1.VChart.hideTooltip(vchart.id), 
            success;
    ...
    beforeRelease() {
        this.event.emit(event_1.ChartEvent.tooltipHide, {
            tooltip: this,
            chart: this.getChart()
        }), this.event.emit(event_1.ChartEvent.tooltipRelease, {
            tooltip: this,
            chart: this.getChart()
        });
    }
    ...
    _initEventOfTooltipContent() {
        ...
        container && (container.addEventListener("pointerenter", (() => {
            ...
            if (this._enterable && (this._isEnterTooltip = !1, "none" !== this._spec.triggerOff && this._cacheEnterableRect)) {
                ...
                this._outTimer = setTimeout(this.hideTooltip, null !== (_c = null === (_b = this._spec) || void 0 === _b ? void 0 : _b.showDelay) && void 0 !== _c ? _c : constant_1.DEFAULT_SHOW_DELAY));
            }
    ...
    _initProcessor() {
        ...
        this.processor = {}, activeType.forEach((type => {
            const instance = factory_1.Factory.createTooltipProcessor(type, this);
    ...
    _initEvent() {
        ...
        const trigger = (0, vutils_1.array)(null !== (_a = this._spec.trigger) && void 0 !== _a ? _a : "hover"), triggerOff = (0, 
        vutils_1.array)(this._spec.triggerOff), mode = this._option.mode;
        trigger.forEach((triggerType => {
            ...
            this._mountEvent("pointermove", {
                ...
                source: "window"
            }, this._getMouseOutHandler(!0))) : (0, vutils_1.isObject)(triggerType) && this._mountEvent(triggerType.eventType, {
                source: null !== (_a = triggerType.source) && void 0 !== _a ? _a : "chart",
                consume: triggerType.consume
            }, this._getMouseMoveHandler(!0));
        }));
        triggerOff.filter((entry => (0, vutils_1.isObject)(entry))).forEach((entry => {
            var _a, _b;
    ...
    _throttle(callback) {
        let wait;
        return wait = (0, vutils_1.isNumber)(this._spec.throttleInterval) ? this._spec.throttleInterval : "html" === this._spec.renderMode && this._spec.transitionDuration ? 50 : 10, 
    ...
    showTooltip(datum, options) {
        ...
        const result = (0, show_tooltip_1.showTooltip)(datum, options, this);
    ...
    _isSameAsCache(nextInfo, nextParams, nextActiveType) {
        ...
        if ((0, util_1.isDimensionInfo)(nextInfo)) {
            ...
            return prevInfo.length === nextInfo.length && nextInfo.every(((info, i) => (0, common_2.isSameDimensionInfo)(info, prevInfo[i])));
        }
        ...
        return !(0, vutils_1.isNil)(prevParams) && !(0, vutils_1.isNil)(nextParams) && (prevParams.mark === nextParams.mark && prevParams.model === nextParams.model && prevParams.datum === nextParams.datum);
    }
