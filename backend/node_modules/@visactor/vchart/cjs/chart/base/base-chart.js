...
class BaseChart extends compilable_base_1.CompilableBase {
    ...
    updateSpec(spec) {
        ...
        for (let i = 0; i < currentKeys.length; i++) {
            ...
            if ((0, util_1.isArray)(this._spec[key]) && this._spec[key].length !== (0, util_1.array)(spec[key]).length) return result.reMake = !0, 
            result;
        }
    ...
    updateComponentSpec(result) {
        ...
        this._components.forEach((c => {
            var _a, _b;
            if (c.type === interface_1.ComponentTypeEnum.label || c.type === interface_1.ComponentTypeEnum.totalLabel) return;
