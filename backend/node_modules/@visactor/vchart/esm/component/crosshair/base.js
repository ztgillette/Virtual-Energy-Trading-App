...
export class BaseCrossHair extends BaseComponent {
    ...
    constructor(spec, options) {
        ...
        this.labelZIndex = LayoutZIndex.CrossHair, this.trigger = "hover", this._handleIn = params => {
            ...
            isNumber(this.triggerOff) && (this._timer && clearTimeout(this._timer), this._timer = setTimeout((() => {
                this._handleOutEvent();
            }), this.triggerOff))));
            this._clickLock = !0;
        }, this._handleHoverInEvent = throttle((params => {
            ...
            if (isObject(this._spec.followTooltip) && !1 === this._spec.followTooltip[params.activeType]) return void this._handleTooltipHideOrRelease();
            const {x: x, y: y} = this.calculateTriggerPoint(params);
    ...
    _registerEvent(eventName, isOut, click) {
        ...
        isArray(eventName) ? eventName.forEach((evt => {
    ...
    _parseCrosshairSpec() {
        ...
        trigger && (this.trigger = trigger), ("none" === triggerOff || isNumber(triggerOff) && triggerOff > 0) && (this.triggerOff = triggerOff), 
    ...
    _parseField(field, fieldName) {
        ...
        if (label.visible) {
            ...
            hair.label = {
                ...
                panel: (isBoolean(labelBackground.visible) ? labelBackground.visible : labelBackground) ? Object.assign({
                    visible: !0,
                    pickable: !1,
                    fill: rectFill,
                    stroke: rectStroke,
