...
export class BaseMark extends GrammarItem {
    ...
    render() {
        this.isCommited() && (!this.getVisible() || this._skipBeforeLayouted && this.getCompiler().getLayoutState() === LayoutState.before || (log(`render mark: ${this.getProductId()}, type is ${this.type}`), 
        this.renderInner()), this.uncommit());
    }
    updateMarkState(key) {
