...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.FastLayout = void 0;

const base_1 = require("./base"), vutils_1 = require("@visactor/vutils");

class FastLayout extends base_1.BaseLayout {
    constructor(options) {
        super((0, vutils_1.merge)({}, FastLayout.defaultOptions, options)), this.random = this.options.random ? Math.random : () => 0, 
        this.aspectRatio = 1;
    }
    fit(word) {
...
exports.FastLayout = FastLayout, FastLayout.defaultOptions = {
    enlarge: !1
};