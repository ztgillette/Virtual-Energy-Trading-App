...
const cloud_layout_1 = require("./cloud-layout"), grid_layout_1 = require("./grid-layout"), fast_layout_1 = require("./fast-layout"), vutils_1 = require("@visactor/vutils"), OUTPUT = {
    x: "x",
    y: "y",
    z: "z",
    ...
    if (fontSizeRange && !(0, vutils_1.isNumber)(fontSize)) {
    ...
    let Layout = cloud_layout_1.CloudLayout;
    "fast" === options.layoutType ? Layout = fast_layout_1.FastLayout : "grid" === options.layoutType && (Layout = grid_layout_1.GridLayout);
...
const field = option => (0, vutils_1.isString)(option) || (0, vutils_1.isNumber)(option) || (0, 
vutils_1.isFunction)(option) || (0, vutils_1.isArray)(option) ? option : datum => datum[option.field], sqrt = x => x < 0 ? -Math.sqrt(-x) : Math.sqrt(x), generateScale = (domain, range, type) => {
