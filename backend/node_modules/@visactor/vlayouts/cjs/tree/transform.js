...
const hierarchy_1 = require("../utils/hierarchy"), format_1 = require("./format"), layout_1 = require("./layout"), transform = (options, upstreamData) => {
    ...
    if (options.flatten) {
        ...
        (0, hierarchy_1.flattenNodes)(res, nodes, {
            maxDepth: maxDepth
        });
        const links = [];
