...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.getAlignEndTexts = exports.getAlignStartTexts = exports.getBoundsOfNodes = exports.formatLinkPath = exports.formatLinkPolygon = exports.formatNodeRect = void 0;

const vutils_1 = require("@visactor/vutils"), formatNodeRect = nodes => nodes.map((node => Object.assign({}, node, {
    x: node.x0,
    y: node.y0,
...
const formatLinkPolygon = links => {
    var _a;
    return !(0, vutils_1.isNil)(null === (_a = null == links ? void 0 : links[0]) || void 0 === _a ? void 0 : _a.vertical) ? links.map((link => {
...
const isNodeVertical = node => node.sourceLinks && node.sourceLinks.length ? !(0, 
vutils_1.isNil)(node.sourceLinks[0].x0) : !(!node.targetLinks || !node.targetLinks.length) && !(0, 
vutils_1.isNil)(node.targetLinks[0].x0), getAlignStartTexts = (nodes, offset = 0) => isNodeVertical(nodes[0]) ? nodes.map((node => ({
    y: node.y1,
    x: (node.x0 + node.x1) / 2,
    datum: node.datum,
    key: node.key
