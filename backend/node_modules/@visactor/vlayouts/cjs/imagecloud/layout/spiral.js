...
const vutils_1 = require("@visactor/vutils"), util_1 = require("../util"), basic_1 = require("./basic"), spirals_1 = require("../../utils/spirals");

class SpiralLayout extends basic_1.Layout {
    preProcess() {
    ...
    tryPlaceImage(image, size, spiralType, segmentationOutput, fixedImages, dt = 1) {
        const [width, height] = size, centerX = width / 2, centerY = height / 2, maxR = Math.sqrt(centerX ** 2 + centerY ** 2), spiral = spirals_1.spirals[spiralType](size);
        let dx, dy, t = -dt;
    ...
    doLayout(images) {
        ...
        const minImageWidth = (0, vutils_1.minInArray)(fixedImages, ((a, b) => a.width - b.width)).width, minImageHeight = (0, 
        vutils_1.minInArray)(fixedImages, ((a, b) => a.height - b.height)).height, fixedFillingImages = [];
        for (let i = 0; i < fillingTimes; i++) {
            ...
            for (const image of images) {
                ...
                (0, util_1.setSize)(fillingImage, imageSize), fillingImage._widthWithPadding = fillingImage.width + 2 * fillingImage.padding, 
