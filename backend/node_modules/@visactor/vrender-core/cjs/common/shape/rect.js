...
function createRectPath(path, x, y, width, height, rectCornerRadius, roundCorner = !0, edgeCb) {
    ...
    width = -width), height < 0 && (y += height, height = -height), (0, vutils_1.isNumber)(rectCornerRadius, !0)) cornerRadius = [ rectCornerRadius = (0, 
    vutils_1.abs)(rectCornerRadius), rectCornerRadius, rectCornerRadius, rectCornerRadius ]; else if (Array.isArray(rectCornerRadius)) {
        ...
        switch (cornerRadiusArr.length) {
          ...
          case 1:
            cr0 = (0, vutils_1.abs)(cornerRadiusArr[0]), cornerRadius = [ cr0, cr0, cr0, cr0 ];
            break;

          case 2:
          case 3:
            cr0 = (0, vutils_1.abs)(cornerRadiusArr[0]), cr1 = (0, vutils_1.abs)(cornerRadiusArr[1]), 
            cornerRadius = [ cr0, cr1, cr0, cr1 ];
            break;

          default:
            cornerRadius = cornerRadiusArr, cornerRadius[0] = (0, vutils_1.abs)(cornerRadius[0]), 
            cornerRadius[1] = (0, vutils_1.abs)(cornerRadius[1]), cornerRadius[2] = (0, vutils_1.abs)(cornerRadius[2]), 
            cornerRadius[3] = (0, vutils_1.abs)(cornerRadius[3]);
        }
    ...
    if (path.moveTo(leftTopPoint1[0], leftTopPoint1[1]), roundCorner) {
        ...
        !(0, vutils_1.arrayEqual)(leftBottomPoint1, leftBottomPoint2)) {
            ...
            edgeCb && edgeCb[2] && path.moveTo(leftBottomPoint1[0], leftBottomPoint1[1]), path.arc(centerX, centerY, _cornerRadius[3], halfPi, vutils_1.pi, !1);
        }
        ...
        !(0, vutils_1.arrayEqual)(leftTopPoint1, leftTopPoint2)) {
            ...
            edgeCb && edgeCb[3] && path.moveTo(leftTopPoint2[0], leftTopPoint2[1]), path.arc(centerX, centerY, _cornerRadius[0], vutils_1.pi, vutils_1.pi + halfPi, !1);
        }
