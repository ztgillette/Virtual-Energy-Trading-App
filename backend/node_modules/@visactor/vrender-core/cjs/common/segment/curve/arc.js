...
const enums_1 = require("../../enums"), base_1 = require("./base");

class ArcCurve extends base_1.Curve {
    constructor(p0, p1, radius) {
        super(), this.type = enums_1.CurveTypeEnum.ArcCurve, this.p0 = p0, this.p1 = p1, 
        this.radius = radius;
    }
    getPointAt(t) {
