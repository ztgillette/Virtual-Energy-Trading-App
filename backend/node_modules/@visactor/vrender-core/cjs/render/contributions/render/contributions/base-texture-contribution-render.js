...
const canvas_allocate_1 = require("../../../../allocator/canvas-allocate"), enums_1 = require("../../../../common/enums"), graphic_1 = require("../../../../graphic"), vutils_1 = require("@visactor/vutils");
...
class DefaultBaseTextureRenderContribution {
    constructor() {
        ...
        this.order = 10, this._tempSymbolGraphic = null;
    }
    ...
    drawTexture(texture, graphic, context, x, y, graphicAttribute, textureColor, textureSize, texturePadding) {
        ...
        if (textureOptions && textureOptions.dynamicTexture) {
            ...
            let newCanvas;
            if (useNewCanvas) {
                newCanvas = canvas_allocate_1.canvasAllocate.allocate({
                    width: b.width(),
                    height: b.height(),
                    dpr: context.dpr
                });
            ...
            this._tempSymbolGraphic || (this._tempSymbolGraphic = (0, graphic_1.createSymbol)({}));
