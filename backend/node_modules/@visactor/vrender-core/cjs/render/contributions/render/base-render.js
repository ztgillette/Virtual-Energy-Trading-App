...
class BaseRender {
    init(contributions) {
        ...
        this.builtinContributions.push(contributions_1.defaultBaseClipRenderBeforeContribution), 
        this.builtinContributions.push(contributions_1.defaultBaseClipRenderAfterContribution), 
        ...
        this._afterRenderContribitions = this._renderContribitions.filter((c => c.time === enums_1.BaseRenderContributionTime.afterFillStroke)));
    }
    reInit() {
