...
export type IMarkAttribute = IGraphicAttribute | IArcAttribute | IAreaAttribute | ICircleAttribute | IEllipseAttribute | IGroupAttribute | IImageAttribute | IIsogonAttribute | ILineAttribute | IPathAttribute | IPolygonAttribute | IRectAttribute | IRichTextAttribute | ISvgAttribute | ISymbolAttribute | ITextAttribute;
export type IThemeAttribute = IArcGraphicAttribute | IAreaGraphicAttribute | ICircleGraphicAttribute | IImageGraphicAttribute | ILineGraphicAttribute | IPathGraphicAttribute | IRectGraphicAttribute | ISymbolGraphicAttribute | ITextGraphicAttribute | IRichTextGraphicAttribute | IWrapTextGraphicAttribute;
