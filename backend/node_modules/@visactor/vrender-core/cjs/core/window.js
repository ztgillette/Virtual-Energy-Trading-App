...
const inversify_lite_1 = require("../common/inversify-lite"), vutils_1 = require("@visactor/vutils"), generator_1 = require("../common/generator"), container_1 = require("../container"), tapable_1 = require("../tapable"), application_1 = require("../application"), event_listener_manager_1 = require("../common/event-listener-manager");

exports.VWindow = Symbol.for("VWindow"), exports.WindowHandlerContribution = Symbol.for("WindowHandlerContribution");

let DefaultWindow = class extends event_listener_manager_1.EventListenerManager {
    get width() {
        if (this._handler) {
    ...
    constructor() {
        super(), this.hooks = {
            ...
            this.actived = !0;
        }, this._uid = generator_1.Generator.GenAutoIncrementId(), this.global = application_1.application.global, 
        this.postInit();
    }
