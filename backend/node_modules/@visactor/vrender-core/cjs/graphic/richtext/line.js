    ...
    draw(ctx, lastLine, x, y, drawEllipsis, drawIcon) {
        if (drawEllipsis && (lastLine || this.paragraphs.some((p => p.overflow)))) {
            ...
            if (!skipEllipsis) for (let i = this.paragraphs.length - 1; i >= 0; i--) {
                ...
                const {width: width} = (0, utils_1.measureTextCanvas)(ellipsis, paragraph.character, paragraph.ascentDescentMode), ellipsisWidth = width || 0;
        ...
        this.paragraphs.forEach(((paragraph, index) => {
            ...
            (0, utils_1.applyStrokeStyle)(ctx, paragraph.character), (0, utils_1.applyFillStyle)(ctx, paragraph.character, b), 
