...
import { LayoutZIndex, normalizeLayoutPaddingSpec, transformToGraphic, TransformLevel, getSpecInfo, CompilableData, VChart, BaseComponent, getDatumOfGraphic } from "@visactor/vchart";
...
export class MapLabelComponent extends BaseComponent {
    constructor() {
        super(...arguments), this.type = "mapLabel", this.name = " mapLabel", this.specKey = "mapLabel", 
        this.transformerConstructor = MapLabelSpecTransformer, this.layoutType = "none", 
        this.layoutZIndex = LayoutZIndex.MarkPoint, this._activeDatum = [];
    }
    ...
    initEvent() {
        ...
        }, (() => (this.handleZoom(), !0))), this.event.on("panmove", {
            filter: params => this._isRelativeModel(params.model)
        }, (e => (this.handlePan(e), !0)));
        const trigger = this._spec.trigger;
        "none" !== trigger && ("hover" === trigger ? (this.event.on("element-highlight:start", (params => {
            const g = params.graphics[0];
            this._isRelativeSeries(g) && this._updateDatum(getDatumOfGraphic(g));
        })), this.event.on("element-highlight:reset", (params => {
            this._activeDatum && this._updateDatum(null);
        }))) : "click" === trigger && (this.event.on("element-select:start", (params => {
            const g = params.graphics[0];
            this._isRelativeSeries(g) && this._updateDatum(getDatumOfGraphic(g));
        })), this.event.on("elementSelectReset", (params => {
            this._activeDatum && this._updateDatum([]);
        }))));
    }
    handlePan(e) {
        const {delta: delta} = e;
    ...
    _evaluateMarker(data, index) {
        ...
        const contentMarks = {}, positionAttr = this.dataToPosition(data), container = graphicCreator.group({});
        ...
        null === (_b = this._spec.background) || void 0 === _b ? void 0 : _b.visible) {
            const labelBackground = graphicCreator.rect(transformToGraphic(Object.assign({}, this._spec.background.style)));
        ...
        if (null === (_c = this._spec.icon) || void 0 === _c ? void 0 : _c.visible) {
            const icon = graphicCreator.symbol(transformToGraphic(Object.assign({}, this._spec.icon.style)));
            icon.setAttributes(positionAttr), icon.setAttribute("symbolType", null !== (_e = null === (_d = this._spec.icon.style) || void 0 === _d ? void 0 : _d.symbolType) && void 0 !== _e ? _e : null === (_f = this._spec.icon.style) || void 0 === _f ? void 0 : _f.shape);
            const iconBound = icon.AABBBounds, iconHeight = null !== (_g = (null == iconBound ? void 0 : iconBound.y2) - (null == iconBound ? void 0 : iconBound.y1)) && void 0 !== _g ? _g : 0, iconWidth = null !== (_h = (null == iconBound ? void 0 : iconBound.x2) - (null == iconBound ? void 0 : iconBound.x1)) && void 0 !== _h ? _h : 0;
            contentMarks.icon = icon, container.appendChild(icon), contentHeight = iconHeight, 
            contentWidth += iconWidth, contentItemCount++;
        }
        if (null === (_j = this._spec.nameLabel) || void 0 === _j ? void 0 : _j.visible) {
            const nameLabel = graphicCreator.text(transformToGraphic(Object.assign({}, this._spec.nameLabel.style)));
            nameLabel.setAttributes(positionAttr), nameLabel.setAttribute("text", data[this.nameField]);
            const nameLabelBound = nameLabel.AABBBounds, nameLabelHeight = null !== (_k = (null == nameLabelBound ? void 0 : nameLabelBound.y2) - (null == nameLabelBound ? void 0 : nameLabelBound.y1)) && void 0 !== _k ? _k : 0, nameLabelWidth = null !== (_l = (null == nameLabelBound ? void 0 : nameLabelBound.x2) - (null == nameLabelBound ? void 0 : nameLabelBound.x1)) && void 0 !== _l ? _l : 0;
        ...
        if ((null === (_m = this._spec.valueLabel) || void 0 === _m ? void 0 : _m.visible) && isValid(data[this.valueField])) {
            const valueLabel = graphicCreator.text(transformToGraphic(Object.assign({}, this._spec.valueLabel.style)));
            valueLabel.setAttributes(positionAttr), valueLabel.setAttribute("text", data[this.valueField]);
            const valueLabelBound = valueLabel.AABBBounds, valueLabelHeight = null !== (_o = (null == valueLabelBound ? void 0 : valueLabelBound.y2) - (null == valueLabelBound ? void 0 : valueLabelBound.y1)) && void 0 !== _o ? _o : 0, valueLabelWidth = null !== (_p = (null == valueLabelBound ? void 0 : valueLabelBound.x2) - (null == valueLabelBound ? void 0 : valueLabelBound.x1)) && void 0 !== _p ? _p : 0;
    ...
    _isRelativeSeries(g) {
        var _a;
        return (null === (_a = g.context) || void 0 === _a ? void 0 : _a.modelId) === this._series.id;
    }
...
MapLabelComponent.type = "mapLabel", MapLabelComponent.specKey = "mapLabel", MapLabelComponent.transformerConstructor = MapLabelSpecTransformer;

export const registerMapLabel = option => {
