...
import type { AdaptiveSpec, ILabelMark } from '@visactor/vchart';
import { FunnelSeries } from '@visactor/vchart';
...
export declare class Funnel3dSeries<T extends IFunnel3dSeriesSpec = IFunnel3dSeriesSpec> extends FunnelSeries<AdaptiveSpec<T, 'type'>> {
    ...
    static readonly builtInTheme: {
        funnel3d: import("@visactor/vchart/src/series/funnel/interface").IFunnelSeriesTheme;
    };
