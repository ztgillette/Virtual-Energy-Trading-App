...
import { ELEMENT_HIGHLIGHT_BY_GRPHIC_NAME, ELEMENT_SELECT_BY_GRPHIC_NAME, PICTOGRAM_SERIES_TYPE, PictogramSeriesMark } from "./constant";
...
import { AttributeLevel, ChartEvent, CompilableData, Factory, GeoSeries, lookup, registerDataSetInstanceTransform, shouldMarkDoMorph, STATE_VALUE_ENUM } from "@visactor/vchart";
...
export class PictogramSeries extends GeoSeries {
    constructor() {
        super(...arguments), this.type = PICTOGRAM_SERIES_TYPE, this._idToMark = new Map;
    }
    setAttrFromSpec() {
        var _a, _b, _c;
...
PictogramSeries.type = PICTOGRAM_SERIES_TYPE, PictogramSeries.mark = PictogramSeriesMark, 
