...
const vutils_1 = require("@visactor/vutils"), vchart_1 = require("@visactor/vchart");
...
const pictogram = data => {
    ...
    if (elements && elements.length) {
        elements.forEach(((el, index) => {
            var _a;
            el[vchart_1.DEFAULT_DATA_INDEX] = index, el._uniqueId = `${el.id}-${index}`, el.data = void 0;
            ...
            if (children && children.length) {
                ...
                for (let j = 0; j < children.length; j++) {
                    ...
                    if ("group" === currentChild.graphicType) curX = startX; else if (currentChild.value && void 0 === currentChild.parent._textGroupStyle.x) {
                        ...
                        if (lastText) {
                            curX += (0, vchart_1.measureText)(lastText.value, lastText._finalAttributes).width;
                        }
