import { MarkTypeEnum } from '@visactor/vchart';
export declare const PICTOGRAM_CHART_TYPE = "pictogram";
export declare const PICTOGRAM_SERIES_TYPE = "pictogram";
export declare const ELEMENT_HIGHLIGHT_BY_GRPHIC_NAME = "element-highlight-by-graphic-name";
export declare const ELEMENT_SELECT_BY_GRPHIC_NAME = "element-select-by-graphic-name";
export declare const enum PictogramMarkNameEnum {
    pictogram = "pictogram"
}
export declare const PictogramSeriesMark: {
    pictogram: {
        name: PictogramMarkNameEnum;
        type: MarkTypeEnum;
    };
