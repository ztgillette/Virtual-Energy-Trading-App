...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.computeDataRange = exports.mergeObjects = exports.applyVisible = void 0;

const vutils_1 = require("@visactor/vutils"), applyVisible = (spec, keyList) => {
    keyList.forEach((key => {
        var _a, _b, _c, _d, _e, _f, _g;
        (0, vutils_1.isArray)(spec[key]) ? null === (_a = spec[key]) || void 0 === _a || _a.forEach(((s, i) => {
            var _a, _b, _c;
...
exports.applyVisible = applyVisible;

const mergeObjects = (objA, objB) => function recursiveMerge(target, source) {
...
exports.computeDataRange = computeDataRange;
