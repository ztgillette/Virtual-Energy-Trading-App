...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.RankingListChartSpecTransformer = void 0;

const vchart_1 = require("@visactor/vchart"), vutils_1 = require("@visactor/vutils"), constant_1 = require("./constant"), utils_1 = require("./utils"), DATA_KEY = "dataKey", ORDER_KEY = "VCHART_ORDER", SUPPLY_DATA_KEY = "SUPPLY_DATA_KEY", NAME_LABEL_PADDING_RIGHT = 10, NAME_ORDER_PADDING_RIGHT = 5, NAME_SYMBOL_PADDING_RIGHT = 8, CHART_PADDING_LEFT = 5, CHART_PADDING_RIGHT = 5, VALUE_LABEL_PADDING_LEFT = 5, LABEL_PADDING_BOTTOM = 5;

class RankingListChartSpecTransformer extends vchart_1.CommonChartSpecTransformer {
    constructor() {
    ...
    normalizeSpec(spec) {
        (0, utils_1.mergeObjects)(spec, constant_1.defaultSpec), (0, utils_1.applyVisible)(spec, [ "barBackground", "rankingIcon", "decorateHaloIcons", "orderLabel", "nameLabel", "valueLabel" ]);
    }
    upgradeTextMeasure(spec) {
        ...
        null === (_c = this.orderLabelTextMeasure) || void 0 === _c || _c.release(), this.nameLabelTextMeasure = new vutils_1.TextMeasure({
            defaultFontParams: null !== (_e = null === (_d = spec.nameLabel) || void 0 === _d ? void 0 : _d.style) && void 0 !== _e ? _e : {}
        }), this.valueLabelTextMeasure = new vutils_1.TextMeasure({
            defaultFontParams: null !== (_g = null === (_f = spec.valueLabel) || void 0 === _f ? void 0 : _f.style) && void 0 !== _g ? _g : {}
        }), this.orderLabelTextMeasure = new vutils_1.TextMeasure({
    ...
    processData(spec) {
        ...
        this.originalSpec = (0, vutils_1.cloneDeep)(spec), this.dataSpecs = this.processRankingData(spec), 
    ...
    transformAxesSpec(spec) {
        const {min: min, max: max} = (0, utils_1.computeDataRange)(this.originalData, spec.xField);
        spec.axes = [ {
            orient: "left",
            type: "band",
            visible: !1,
