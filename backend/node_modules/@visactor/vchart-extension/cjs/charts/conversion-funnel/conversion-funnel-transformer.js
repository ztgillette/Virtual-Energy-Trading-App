...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.ConversionFunnelChartSpecTransformer = void 0;

const vchart_1 = require("@visactor/vchart"), vutils_1 = require("@visactor/vutils"), constants_1 = require("./constants");

class ConversionFunnelChartSpecTransformer extends vchart_1.FunnelChartSpecTransformer {
    transformSpec(spec) {
...
function generateArrowLineSpec(line = {}, margin) {
    ...
    return Object.assign(Object.assign({
        ...
        style: Object.assign(Object.assign(Object.assign({}, constants_1.DEFAULT_ARROW_MARK_STYLE), style), {
...
function generateArrowSymbolSpec(symbol = {}, margin) {
    ...
    return Object.assign(Object.assign({
        ...
        style: Object.assign(Object.assign(Object.assign({}, constants_1.DEFAULT_ARROW_SYMBOL_MARK_STYLE), style), {
            x: (arrow, ctx) => {
                var _a, _b;
                let points = arrow.layout.points;
...
function generateArrowTextSpec(text = {}, margin) {
    ...
    return Object.assign(Object.assign({
        ...
        style: Object.assign(Object.assign(Object.assign({}, constants_1.DEFAULT_ARROW_TEXT_MARK_STYLE), {
            text: (arrow, ctx) => {
                var _a, _b, _c, _d, _e, _f, _g;
                const {text: textContent} = arrow;
                let displayTextContent = textContent;
                if ((0, vutils_1.isFunction)(formatMethod)) {
...
function addFunnelBackgroundMark(funnelBackground) {
    ...
    return Object.assign(Object.assign({
        ...
        dataIndex: 0,
        zIndex: 0,
        style: Object.assign(Object.assign(Object.assign({}, constants_1.DEFAULT_FUNNEL_BACKGROUND_MARK_STYLE), style), {
            x: 0,
