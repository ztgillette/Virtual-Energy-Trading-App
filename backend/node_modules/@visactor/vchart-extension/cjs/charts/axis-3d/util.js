...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.getUpdateAttributeOfZAxis = void 0;

const vchart_1 = require("@visactor/vchart"), getUpdateAttributeOfZAxis = (axis, ignoreGrid) => {
    var _a;
    const regionSize = (0, vchart_1.getCombinedSizeOfRegions)(axis.getRegions()), {width: width} = axis.getLayoutRect(), axisLength = width, depth = axis.layout3dBox ? axis.layout3dBox.length : 0, depthZ = axis.layout3dBox ? axis.layout3dBox.width : 0, end = {
        x: depth,
        y: 0
    }, items = axis.getLabelItems(axisLength), attrs = {
        start: {
            x: 0,
            y: 0
        },
        ...
        title: {
            ...
            maxWidth: axis._getTitleLimit(!1)
        },
        items: items,
