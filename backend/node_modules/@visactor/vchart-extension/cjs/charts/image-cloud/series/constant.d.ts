...
export declare const IMAGE_CLOUD_CHART_TYPE = "imageCloud";
export declare const IMAGE_CLOUD_SERIES_TYPE = "imageCloud";
export declare const enum ImageCloudMarkNameEnum {
    image = "image",
    imageMask = "imageMask"
}
export declare const imageCloudSeriesMark: {
    image: {
