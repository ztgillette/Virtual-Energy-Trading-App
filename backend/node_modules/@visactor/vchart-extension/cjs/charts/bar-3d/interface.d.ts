import type { BarAppearPreset, IAnimationSpec, IBarSeriesSpec, ICartesianChartSpec, ICartesianSeriesSpec, ICartesianSeriesTheme, IChartExtendsSeriesSpec, IMarkTheme } from '@visactor/vchart';
...
export type IBar3dSeriesSpec = {
    type: 'bar3d';
} & Omit<IBarSeriesSpec, 'type'> & ICartesianSeriesSpec & IAnimationSpec<'bar', BarAppearPreset>;
